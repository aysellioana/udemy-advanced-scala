...
object FuturesPromises extends App {
  ...
  aFuture.onComplete(t => t match {
    case Success(meaningOfLife) => println(s"the mening of life is $meaningOfLife")
  ...
  2. inSequence(fa, fb)
  3. first(fa, fb) => new future with the first value of the futures
  4. last(fa, fb) => new future with the lase value
